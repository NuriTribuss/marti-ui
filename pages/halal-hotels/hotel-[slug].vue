        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="sidebar single-content-sidebar mb-0">
              ...
              <!-- end sidebar-widget -->
               <div class="sidebar-widget  single-content-widget font-size-14 line-height-24" v-for="(feature,index) in features "  :key="index">
                    <h3 class="title stroke-shape">
                        <i class="la la-concierge-bell text-color-4 me-2"></i>{{ feature.title }}
                    </h3>
                    <div class="sidebar-category" >
                        <p v-for="(f,i) in feature.children" :key="i"><i class="la la-check me-2 text-success font-weight-bold"></i>{{ f }}</p>
                    </div>
              </div>
            ...
            <div class="single-content-wrap">
              <div class="tab-content margin-bottom-40px" id="myTabcontent">
                ...
                <div v-show="loaders.hotel">
                 ...
                 <HalalHotelOffer v-for="(offer,index) in offerList" :key="index" :index="index" v-bind:offer="offer" :search="searchData" />
                </div>
