             ...
             <div class="tour-card card-item card-item-list ">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="mt-0 mt-lg-4 pb-3 ">
                          ...
                          <a v-if="searchData.source == null" :href="'/tour/'+tour.seo_url+'?tid='+tour.id" class="float-end btn theme-btn-blue rounded-0  px-5 text-white">{{ $t('tour.look')}}</a>
                          <a v-else :href="'/tour/'+tour.seo_url+'?tid='+tour.id+'&station='+searchData.source" class="float-end btn theme-btn-blue rounded-0  px-5 text-white">{{ $t('tour.look')}}</a>
                        </div>
                    </div>
                </div>
           </div>
